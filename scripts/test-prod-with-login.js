...
async function login(email, password) {
  ...
  // Also check for set-cookie header
...
async function testAPI(endpoint, params, authToken, iterations = 10) {
...
async function main() {
  console.log('==============================================');
  console.log('PRODUCTION Performance Test with Login');
  console.log(`Testing against: ${BASE_URL}`);
  console.log('==============================================\n');
  
  try {
    // Login first
    const authToken = await login('simon@holmesacourt.com', 'password');
    console.log('\n');
    ...
    console.log('=====================================');
    const regularStats = await testAPI('/api/history', params, authToken, 20);
    ...
    console.log('=====================================');
    const fastStats = await testAPI('/api/history-fast', params, authToken, 20);
    
    // Compare results
    if (regularStats && fastStats) {
      console.log('\n==============================================');
      console.log('COMPARISON RESULTS (PRODUCTION)');
      console.log('==============================================');
      ...
      if (fastStats.median < 100) {
        console.log(`\n✅ Fast API achieving sub-100ms response times in production!`);
      }
    ...
    console.log('\n==============================================');
    console.log('Note: Production times include network latency');
    console.log('==============================================');
  } catch (error) {
