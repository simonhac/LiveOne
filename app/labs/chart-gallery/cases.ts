...
export const CHART_CASES: ChartCase[] = [
  ...
  // --- lines variant: the shapes that expose the known legend defects -----------------------
  {
    ...
    range: "D",
    noBattery: true,
    note: "DEFECT #3: batteryW is an all-nulls array (not undefined), so a phantom Battery dataset is added",
    width: W,
    height: H,
  },
  {
  ...
  },
  {
    ...
    range: "M",
    noBattery: true,
    note: "DEFECT #3 at its most visible: a phantom bar dataset should narrow/offset the real grouped bars",
    width: W,
    height: H,
  },
  {
    ...
    range: "D",
    withGap: true,
    note: "null hole mid-window — gap rendering, and the legend flicker of DEFECT #2 when focused inside it",
    width: W,
    height: H,
  },
  {
    ...
    range: "D",
    focusAt: 0.62,
    note: "crosshair + the legend WITH values — the state where Battery/Grid entries appear (DEFECT #1)",
    width: W,
    height: H,
  },
  {
    ...
    withGap: true,
    focusAt: 0.46,
    note: "DEFECT #2 pinned: focus lands inside the hole, so Battery/Grid vanish mid-hover",
    width: W,
    height: H,
  },
