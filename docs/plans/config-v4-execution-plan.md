...
## ▶ NEXT ACTION — Phase 9: PR 1 ✅ + PR 2 ✅ landed → PR 3 (aesthetic changes, TBD)
...
> Post-cutover teardown" section below. **PR 1 is committed (`2b91688d`); PR 2 is implemented +
> verified live, not yet committed as of this writing (see their sections below); PR 3 not yet scoped.**
...
| 9 — post-cutover: sync fix + areas TypeID uniformity   | 🔄 IN PROGRESS (PR1 ✅ + PR2 ✅) | Scoped 2026-07-26: PR 1 (sync-prod-to-dev FK fix, Option A2) ✅ committed `2b91688d` + PR 2 (`areas` TypeID uniformity, Plan B full flip) ✅ implemented + verified live, not yet committed + PR 3 (aesthetic, TBD, not started); rest deferred to Phase 10. See § Phase 9.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
**✅ Landed + verified live (2026-07-27).** All 4 commits implemented; `npm run build:local` +
