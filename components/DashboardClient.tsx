...
export default function DashboardClient({
  ...
  // Whether a chart's axis strip will be there to step the window on touch — a fact about the
  // document, so it is settled before the first paint and the prev/next pill never appears and
  // then vanishes. See `mayHaveAxisTapChart`.
  const axisNavExpected = mayHaveAxisTapChart(dashboard.doc);
  const navRowPending =
    !areasResolved &&
