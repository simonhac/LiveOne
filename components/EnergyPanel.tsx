...
export default function EnergyPanel({
  ...
  const getYesterdayPower = (
    ...
    return calculateYesterdayPower(
      historical.yesterday.energy[energyField],
      historical.yesterday.dataQuality.intervalCount,
    );
  };

  // Helper function to convert formatted result to JSX
  const toJSX = (formatted: {
    value: string;
    unit: string;
  }): React.JSX.Element => (
    <Value
        ...
        <table className="w-full energy-table">
          <thead>
            <tr className="border-b border-gray-700">
              ...
              <th className="text-right py-1 text-gray-400 font-medium text-xs">
                Solar
              </th>
              <th className="text-right py-1 text-gray-400 font-medium text-xs">
                Load
              </th>
              <th className="text-right py-1 text-gray-400 font-medium text-xs hidden sm:table-cell">
                Battery In
              </th>
              <th className="text-right py-1 text-gray-400 font-medium text-xs hidden sm:table-cell">
                Battery Out
              </th>
              <th className="text-right py-1 text-gray-400 font-medium text-xs sm:hidden">
                Battery In/Out
              </th>
              {showGrid && (
                <>
          ...
          <tbody>
            {/* Today Row */}
            <tr className="border-b border-gray-700">
              <td className="py-1.5 font-medium text-gray-300 text-xs">
                Today
              </td>
              <td className="text-right py-1.5 text-yellow-400 text-sm">
                {showPower
                  ? formatValueJSX(
                      calculateTodayPower(energy.today.solarKwh),
                      "W",
                    )
              ...
              <td className="text-right py-1.5 text-blue-400 text-sm">
                {showPower
                  ? formatValueJSX(
                      calculateTodayPower(energy.today.loadKwh),
                      "W",
                    )
              ...
              <td className="text-right py-1.5 text-green-400 text-sm hidden sm:table-cell">
                {showPower
                  ? formatValueJSX(
                      calculateTodayPower(energy.today.batteryInKwh),
                      "W",
                    )
              ...
              <td className="text-right py-1.5 text-orange-400 text-sm hidden sm:table-cell">
                {showPower
                  ? formatValueJSX(
                      calculateTodayPower(energy.today.batteryOutKwh),
                      "W",
                    )
              ...
              <td className="text-right py-1.5 text-green-400 text-sm sm:hidden">
                {showPower
                  ...
                  : formatValuePairJSX(
                      energy.today.batteryInKwh,
                      energy.today.batteryOutKwh,
                      "kWh",
                    )}
              </td>
              {showGrid && (
                <>
                  <td className="text-right py-1.5 text-red-400 text-sm hidden sm:table-cell">
                    {showPower
                      ? formatValueJSX(
                          calculateTodayPower(energy.today.gridInKwh),
                          "W",
                        )
                  ...
                  <td className="text-right py-1.5 text-green-400 text-sm hidden sm:table-cell">
                    {showPower
                      ? formatValueJSX(
                          calculateTodayPower(energy.today.gridOutKwh),
                          "W",
                        )
                  ...
                  <td className="text-right py-1.5 text-red-400 text-sm sm:hidden">
                    {showPower
                      ...
                      : formatValuePairJSX(
                          energy.today.gridInKwh,
                          energy.today.gridOutKwh,
                          "kWh",
                        )}
                  </td>
                </>
            ...
            <tr className="border-b border-gray-700">
              ...
              <td className="text-right py-1.5 text-yellow-400 text-sm">
                {showPower
                  ...
                  : formatValueJSX(
                      historical?.yesterday?.energy?.solarKwh,
                      "kWh",
                    )}
              </td>
              <td className="text-right py-1.5 text-blue-400 text-sm">
                {showPower
                  ...
                  : formatValueJSX(
                      historical?.yesterday?.energy?.loadKwh,
                      "kWh",
                    )}
              </td>
              <td className="text-right py-1.5 text-green-400 text-sm hidden sm:table-cell">
                {showPower
                  ...
                  : formatValueJSX(
                      historical?.yesterday?.energy?.batteryChargeKwh,
                      "kWh",
                    )}
              </td>
              <td className="text-right py-1.5 text-orange-400 text-sm hidden sm:table-cell">
                {showPower
                  ? formatValueJSX(
                      getYesterdayPower("batteryDischargeKwh"),
                      "W",
                    )
                  : formatValueJSX(
                      historical?.yesterday?.energy?.batteryDischargeKwh,
                      "kWh",
                    )}
              </td>
              <td className="text-right py-1.5 text-green-400 text-sm sm:hidden">
                {showPower
                  ? formatValuePairJSX(
                      getYesterdayPower("batteryChargeKwh"),
                      getYesterdayPower("batteryDischargeKwh"),
                      "W",
                    )
                  : formatValuePairJSX(
                ...
                <>
                  <td className="text-right py-1.5 text-red-400 text-sm hidden sm:table-cell">
                    {showPower
                      ...
                      : formatValueJSX(
                          historical?.yesterday?.energy?.gridImportKwh,
                          "kWh",
                        )}
                  </td>
                  <td className="text-right py-1.5 text-green-400 text-sm hidden sm:table-cell">
                    {showPower
                      ...
                      : formatValueJSX(
                          historical?.yesterday?.energy?.gridExportKwh,
                          "kWh",
                        )}
                  </td>
                  <td className="text-right py-1.5 text-red-400 text-sm sm:hidden">
                    {showPower
                      ? formatValuePairJSX(
                          getYesterdayPower("gridImportKwh"),
                          getYesterdayPower("gridExportKwh"),
                          "W",
                        )
                      : formatValuePairJSX(
                          historical?.yesterday?.energy?.gridImportKwh,
            ...
            <tr>
              ...
              <td className="text-right py-1.5 text-green-400 text-sm sm:hidden">
                {formatValuePairJSX(
                  energy.total.batteryInKwh,
                  energy.total.batteryOutKwh,
                  "kWh",
                )}
              </td>
              {showGrid && (
                <>
                  ...
                  <td className="text-right py-1.5 text-red-400 text-sm sm:hidden">
                    {formatValuePairJSX(
                      energy.total.gridInKwh,
                      energy.total.gridOutKwh,
                      "kWh",
                    )}
                  </td>
                </>
