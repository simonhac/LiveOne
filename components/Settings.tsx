...
export default function Settings({ isOpen, onClose }: SettingsProps) {
  ...
  const { data: enphaseStatus = { connected: false } } =
    useQuery<EnphaseStatus>({
      queryKey: ["enphaseStatus"],
      queryFn: () => fetchJson<EnphaseStatus>("/api/auth/enphase/disconnect"),
      enabled: isOpen,
    });
  ...
  const disconnectMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.setQueryData(["enphaseStatus"], { connected: false });
  ...
  // Connect redirects, so it stays "loading" until navigation; keep both buttons disabled while either runs.
                    ...
                    <div>
                      ...
                      <div className="bg-gray-800 rounded-lg p-3 mb-4">
                        ...
                        <ol className="text-sm text-gray-400 space-y-1 list-decimal list-inside">
                          <li>
                            You&apos;ll be redirected to Enphase to log in
                          </li>
