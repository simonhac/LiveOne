...
describe("formatFlowMagnitude", () => {
  test("keeps 1dp below 100", () => {
    expect(formatFlowMagnitude(0)).toBe("0.0");
    expect(formatFlowMagnitude(58.4)).toBe("58.4");
    expect(formatFlowMagnitude(99.9)).toBe("99.9");
    expect(formatFlowMagnitude(99.94)).toBe("99.9"); // rounds to 99.9 → keep decimal
  });

  test("drops the decimal once it would display as 100+ ('over 99.9')", () => {
    expect(formatFlowMagnitude(99.96)).toBe("100"); // rounds to 100.0 → never "100.0"
    expect(formatFlowMagnitude(100)).toBe("100");
    expect(formatFlowMagnitude(123.4)).toBe("123");
    expect(formatFlowMagnitude(999.5)).toBe("1000");
  });
});
...
describe("formatValue", () => {
  ...
  test("formats base unit Wh correctly", () => {
    ...
    expect(formatValue(1500000000, "Wh")).toEqual({
      value: "1.5",
      unit: "GWh",
    });
  });
...
describe("formatValuePair", () => {
  test("handles both values null/undefined", () => {
    expect(formatValuePair(null, null, "W")).toEqual({
      value: "—/—",
      unit: "",
    });
    expect(formatValuePair(undefined, undefined, "kWh")).toEqual({
      value: "—/—",
      unit: "",
    });
    expect(formatValuePair(null, undefined, "W")).toEqual({
      value: "—/—",
      unit: "",
    });
  });
  ...
  test("handles in value null, out value valid", () => {
    expect(formatValuePair(null, 1500000, "W")).toEqual({
      value: "—/1.5",
      unit: "MW",
    });
    expect(formatValuePair(undefined, 750, "kWh")).toEqual({
      value: "—/750.0",
      unit: "kWh",
    });
  });
  ...
  test("handles in value valid, out value null", () => {
    expect(formatValuePair(1200000, null, "W")).toEqual({
      value: "1.2/—",
      unit: "MW",
    });
    expect(formatValuePair(800, undefined, "kWh")).toEqual({
      value: "800.0/—",
      unit: "kWh",
    });
  });
  ...
  test("handles both values valid with same SI prefix", () => {
    expect(formatValuePair(1200000, 1800000, "W")).toEqual({
      value: "1.2/1.8",
      unit: "MW",
    });
    expect(formatValuePair(500, 750, "kWh")).toEqual({
      value: "500.0/750.0",
      unit: "kWh",
    });
  });
  ...
  test("handles both values valid requiring different SI prefixes (uses max)", () => {
    expect(formatValuePair(500000, 1500000000, "W")).toEqual({
      value: "0.0/1.5",
      unit: "GW",
    });
    expect(formatValuePair(2000000, 800, "kWh")).toEqual({
      value: "2.0/0.0",
      unit: "GWh",
    });
  });
  ...
  test("handles negative values correctly", () => {
    ...
    expect(formatValuePair(-2500, -1200, "kWh")).toEqual({
      value: "-2.5/-1.2",
      unit: "MWh",
    });
  });
  ...
  test("handles zero values correctly", () => {
    expect(formatValuePair(0, 1500000, "W")).toEqual({
      value: "0.0/1.5",
      unit: "MW",
    });
    expect(formatValuePair(0, 0, "kWh")).toEqual({
      value: "0.0/0.0",
      unit: "kWh",
    });
  });
  ...
  test("works with W metric", () => {
    expect(formatValuePair(1500000, 2500000, "W")).toEqual({
      value: "1.5/2.5",
      unit: "MW",
    });
  });
  ...
  test("works with Wh metric", () => {
    expect(formatValuePair(1500, 2500, "kWh")).toEqual({
      value: "1.5/2.5",
      unit: "MWh",
    });
  });
  ...
  test("handles values with different magnitudes correctly (original bug case)", () => {
    ...
    expect(formatValuePair(1625, 107, "W")).toEqual({
      value: "1.6/0.1",
      unit: "kW",
    });
  });
  ...
  test("handles values with very different magnitudes correctly", () => {
    ...
    expect(formatValuePair(2000, 50, "W")).toEqual({
      value: "2.0/0.1",
      unit: "kW",
    });
  });
  ...
  test("handles MW scale with smaller value correctly", () => {
    ...
    expect(formatValuePair(1500000, 50000, "W")).toEqual({
      value: "1.5/0.1",
      unit: "MW",
    });
  });
  ...
  test("handles kW input with mixed values", () => {
    expect(formatValuePair(1200, 1800, "kW")).toEqual({
      value: "1.2/1.8",
      unit: "MW",
    });
    expect(formatValuePair(500, 750, "kW")).toEqual({
      value: "500.0/750.0",
      unit: "kW",
    });
    expect(formatValuePair(1.625, 0.107, "kW")).toEqual({
      value: "1.6/0.1",
      unit: "kW",
    });
  });
