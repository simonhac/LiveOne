import type { VendorAdapter, PollingResult, TestConnectionResult } from './types';
...
export abstract class BaseVendorAdapter implements VendorAdapter {
   ...
   */
  protected async getLastPollTime(system: SystemWithPolling): Promise<Date | null> {
   ...
   */
  async poll(system: SystemWithPolling, credentials: any, force: boolean, now: Date): Promise<PollingResult> {
