...
/**
 * The Tesla "T" mark — the glyph only, no wordmark.
 *
 * Unlike the Amber marks this takes `fill="currentColor"`, so the caller sets
 * the colour with a text-* class (the tile renders it white).
 *
 * Path: simple-icons (CC0).
 */
