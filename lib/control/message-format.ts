 ...
 * ## The problem
 *
 * The usher hub writes sentences that are read by a human in a browser ("Running until
 ...
 *
 *   {
 *     template: "Running until {stopAt, time, short} — starting again extends the run.",
